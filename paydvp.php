...
function confirm()
{
alert('Transaction successfull. Booking Confirmed');
}
</script>
</head>
<center>
...
$id=$_SESSION['id'];
$q="insert into book values('$id','Proshow Day 1','6th Feb, 2020-6 p.m.','VIT Cricket Ground');";

mysqli_query($con,$q);
mysqli_close($con);

$sub = "Booking confirmed";
$msg = "You have booked your seat for Proshow Day 1!"."\n"."Use this mail as the Confirmation pass.";
